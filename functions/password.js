...
exports.resetPasswordInit = email =>
	...
	new Promise((resolve, reject) => {
		...
		user.find({ email: email })
			...
			.then(user => {
				var mailOptions = {
					from: 'ifpprueba@gmail.com',
					to: email,
					subject: 'Cambio de pass',
					  html: '<b>Buenas '+user.name+ '</b><br> le informamos que se han realizado una solicitud de reseteo de password<br/>Si es usted, introduzca el siguiente token:'+
					  '<b>'+ random +'</b><br><br>Si estas abriendo esto desde el dispositivo android acceda a este enlace: <a href = "http://nachetons/'+random+'">link</a><br>'+
					  /*AQUI PONDREMOS NUESTRA PAGINA Y EL LOGO*/'<a href = "nachetons/'+random+'"><img src="https://www.wndgroup.io/wp-content/uploads/2018/12/encryption-logo.jpg" alt="No cargo la imagen"/></a>',
				};
